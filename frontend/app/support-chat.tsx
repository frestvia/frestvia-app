...
const CHAT_STORAGE_KEY = '@forgetly_support_chat';
    ...
    try {
      ...
      if (!saved || JSON.parse(saved).messages?.length === 0) {
        ...
        const welcome: Message = {
          id: 'welcome',
          text: 'Hi there! I\'m Forgetly\'s AI assistant. How can I help you today? You can ask me about checklists, premium features, reminders, shared lists, or anything else!',
          isUser: false,
          timestamp: Date.now(),
          status: 'sent',
        };
