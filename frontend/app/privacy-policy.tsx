...
export default function PrivacyPolicyScreen() {
  ...
  const openEmail = () => {
    Linking.openURL(`mailto:${SUPPORT_EMAIL}?subject=${encodeURIComponent('Frestivia Privacy Inquiry')}`).catch(() => {});
  };
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <Text style={[styles.intro, { color: colors.textSecondary }]}>
          Frestivia ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our mobile application.
        </Text>
...
{'Frestivia is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13.'}
        </Section>
