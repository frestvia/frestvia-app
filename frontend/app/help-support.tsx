      ...
      >
        ...
        >
          ...
          <View style={styles.chatCardContent}>
            ...
            <Text style={[styles.chatCardDesc, { color: colors.textSecondary }]}>
              Get instant help from our AI assistant. Available 24/7 for any questions about Frestvia.
            </Text>
          </View>
        ...
        <View style={[styles.contactCard, { backgroundColor: colors.card }]}>
          ...
          <Pressable
            ...
            onPress={() => openEmail('Frestvia Support Request')}
            android_ripple={{ color: isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)' }}
          >
          ...
          <Pressable
            ...
            onPress={() => openEmail('Frestvia Bug Report')}
            android_ripple={{ color: isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)' }}
          >
